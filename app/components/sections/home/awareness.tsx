...
const Awareness = () => {
  ...
  return (
    <section
      className="flex  items-center  gap-2  w-full   relative  min-h-screen  overflow-hidden px-10 justify-center  max-md:min-h-auto  max-2xs:px-1 "
    ...
    >
      ...
      <div className="flex  items-center  gap-2     relative  min-h-screen  overflow-hidden px-10 justify-center w-[1100px]  max-xl:px-0  max-lg:min-h-auto  max-md:flex-col  max-md:py-8">
        <div className="w-[50%]    p-4 shrink-0 flex flex-col items-start  gap-4 h-full  max-md:self-end  max-md:w-[450px]  max-xs:w-full">
          ...
          <h1 className="text-lg  max-md:text-base max-xs:leading-none  max-xs:font-normal max-xs:text-sm text-[#ffffffcc] text-pretty">
            Spark keeps track of your past questions and actions. so
        ...
        <div className="w-[50%]    shrink-0  flex items-start  justify-end h-[80vh]  max-md:self-start  max-md:h-auto max-md:w-full max-md:justify-start max-2xs:self-center max-2xs:justify-center  max-md:order-1 ">
